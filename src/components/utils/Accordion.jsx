...
const Accordion = ({
    ...
    return (
        <div className={`border border-gray-100 mb-3 ${isOpen ? 'shadow-md' : ''}`}>
            <div className={`pl-5  ${verified ? `${bgColor} border border-green-400` : 'bg-gray-100'} ${!reset ? 'bg-red-50 border border-red-400' : ''}`}>
                <div className="grid grid-cols-1 md:grid-cols-7 items-center hover:cursor-pointer" onClick={toggleAccordion}>
